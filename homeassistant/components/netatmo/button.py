...
PREFERRED_POSITION_BUTTON: ButtonEntityDescription = ButtonEntityDescription(
...
async def async_setup_entry(
    ...
    def _create_entity(netatmo_device: NetatmoDevice) -> None:
        entity = NetatmoCoverButton(netatmo_device, PREFERRED_POSITION_BUTTON)
...
class NetatmoCoverButton(NetatmoModuleEntity, ButtonEntity):
    """Representation of a Netatmo cover button device."""

    _attr_configuration_url = CONF_URL_CONTROL
    device: NaModules.Shutter

    def __init__(
        self, netatmo_device: NetatmoDevice, description: ButtonEntityDescription
    ) -> None:
    ...
    async def async_press(self) -> None:
        """Button to move the cover to a preferred position."""
